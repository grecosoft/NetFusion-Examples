using Examples.Messaging.App.Plugin;
using Examples.Messaging.Domain.Plugin;
using Examples.Messaging.Infra;
using Examples.Messaging.Infra.Plugin;
using Examples.Messaging.WebApi.Plugin;
...
try
{
    ...
    builder.Services.CompositeContainer(builder.Configuration, new SerilogExtendedLogger())
        ...
        {
            c.AddPublisher<PrintMessagePublisher>();
